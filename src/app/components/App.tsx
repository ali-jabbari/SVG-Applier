...
function App() {
    ...
    const onApplyHandler = () => {
        const image = '<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="16" height="16"\n' +
        ...
        parent.postMessage({pluginMessage: {type: 'apply-svg', image }}, '*');
    }
    ...
    return (
        <div>
            ...
            <button className='btn' onClick={onRemoveHandler}>
                Remove SVG
            </button>
